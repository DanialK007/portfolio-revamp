    ...
    >
      <div className="absolute z-20 inset-0 flex flex-col items-start lg:items-center justify-center text-white bg-gradient-to-t from-black to-80% from-10%">
        <div className="backdrop-blur-md flex items-end lg:justify-center pb-5">
          <div className="hidden lg:block text-3xl sm:text-5xl md:text-6xl text-white/60 lg:text-7xl xl:text-8xl font-bold uppercase">
            H<span className="lowercase">i</span>, <spanc className="text-white"> Welcome </spanc> home
          </div>
        ...
        <div className="pt-5 flex items-start lg:justify-center px-10 sm:px-16">
          <div className="hidden lg:flex text-3xl sm:text-5xl md:text-6xl text-white/60 lg:text-7xl xl:text-8xl font-bold uppercase">
            It's me,
