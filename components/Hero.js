...
function Hero() {
  return (
    ...
    >
      ...
      <div className="text-3xl sm:text-5xl md:text-6xl text-white/60 lg:text-7xl xl:text-8xl font-semibold uppercase">
        Hi, <spanc className="text-white"> Welcome </spanc> home
      </div>
      <div className="text-3xl sm:text-5xl md:text-6xl text-white/60 lg:text-7xl xl:text-8xl font-semibold uppercase flex">
        It's me,
