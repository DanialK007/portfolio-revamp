...
function PlayGround() {
  ...
  const projects = [
    {
      ...
      photos: ["img/venue.png", "img/venue.png", "img/venue.png", "img/venue.png", "img/venue.png"],
    ...
    },
    {
      ...
      photos: ["img/gymnast.png", "img/gymnast.png", "img/gymnast.png", "img/gymnast.png", "img/gymnast.png"],
    ...
    },
    {
      ...
      photos: ["img/morph.png", "img/morph.png", "img/morph.png", "img/morph.png", "img/morph.png"],
    ...
    },
    {
      ...
      photos: ["img/leiga.png", "img/leiga.png", "img/leiga.png", "img/leiga.png", "img/leiga.png"],
    ...
    },
    {
      ...
      imgSrc: "img/acme.png",
      photos: ["img/acme.png", "img/acme.png", "img/acme.png", "img/acme.png", "img/acme.png"],
    ...
    },
    {
      ...
      photos: ["img/pireal.png", "img/pireal.png", "img/pireal.png", "img/pireal.png", "img/pireal.png"],
    ...
    },
    {
      ...
      photos: ["img/orange.png", "img/orange.png", "img/orange.png", "img/orange.png", "img/orange.png"],
    ...
    },
    {
      ...
      photos: ["img/wright.png", "img/wright.png", "img/wright.png", "img/wright.png", "img/wright.png"],
  ...
  return (
    <div className="my-5 xl:mt-20 relative">
      ...
      <div className="grid grid-cols-1 p-5 gap-3 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2">
